...
## Project Structure
    ...
    ├── testapiautostoryboa_54665  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_54665`
...
2. Clone this repo and `cd testapiautostoryboa_54665`
